...
class PlayerBumperDevice(PlayerDevice):
    def __init__(self, client):
        ...
        self.groups = {'all': list(range(len(self))),
                       'front': list(range(0, len(self)/2 + 1)),
                       'back': list(range(len(self)/2 + 1, len(self))),
                       }
        self.units    = "RAW"
...
class PlayerLaserDevice(PlayerDevice):
    def __init__(self, client):
        ...
        self.groups = {'all': list(range(count)),
                       'right': list(range(0, posB)),
                       'left': list(range(posF, end)),
                       'front': list(range(posC, posE)),
                       'front-right': list(range(posB, posD)),
                       'front-left': list(range(posD, posF)),
                       'front-all': list(range(posB, posF)),
                       'right-front': list(range(posA, posB)),
                       'right-back': list(range(start, posA)),
                       'left-front': list(range(posF,posG)),
                       'left-back': list(range(posG,end)),
                       'back-right': [],
                       'back-left': [],
                       'back': [],
                       'back-all': []}
