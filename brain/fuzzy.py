...
class FuzzyClassifier:
  ...
  def __call__(self, *args):
    ...
    mydict = {}
    args = list(args)
    funcargs = list(self.Function.__code__.co_varnames
    ...
    x = len(mydict) - self.Function.__code__.co_argcount
    if x == -1:
