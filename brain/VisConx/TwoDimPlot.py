...
class TwoDimPlot(tkinter.Toplevel):
    ...
    def relabelXAxis(self):
        ...
        """
        newLabels = [self.xMax*float(i+1)/self.xNumTicks for i in range(self.xNumTicks)]
        for i in range(len(self.xTickLabels)):
    ...
    def relabelYAxis(self):
        ...
        for i in range(0,self.yNumTicks):
    ...
    def writeToFile(self):
        ...
        """
        fileWindow = tkinter.filedialog.SaveAs(self)
        ...
        try:
            ...
            tkinter.messagebox.showerror("File Error", "Writing to file failed.")
